...
<ZoomableImage src="/docs/images/services/pydio-screenshot-1.webp" alt="Pydio Cells Onboarding" />

The database details can be found on Coolify dashboard:

<ZoomableImage src="/docs/images/services/pydio-screenshot-2.webp" alt="Pydio Cells Onboarding" />
