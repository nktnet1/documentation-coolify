...
<ZoomImage src="/docs/images/aws-s3/header.webp" alt="Coolify header" />
...
<ZoomImage src="/docs/images/aws-s3/1.webp" alt="Screenshot of Aws" />

You’ll be asked to choose a name, object ownership, and so on.

<ZoomImage src="/docs/images/aws-s3/2.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/3.webp" alt="Screenshot of Aws" />
<br />
<ZoomImage src="/docs/images/aws-s3/4.webp" alt="Screenshot of Aws" />
<br />
<ZoomImage src="/docs/images/aws-s3/5.webp" alt="Screenshot of Aws" />

Click on **Create Bucket** button

Once the bucket is created you will be redirected to this page:
<ZoomImage src="/docs/images/aws-s3/6.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/7.webp" alt="Screenshot of Aws" />
<br />
<ZoomImage src="/docs/images/aws-s3/8.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/9.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/10.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/11.webp" alt="Screenshot of Aws" />

You’ll be asked to choose a name for the user:
<ZoomImage src="/docs/images/aws-s3/12.webp" alt="Screenshot of Aws" />
  - Click on **Next** button after you have entered a name for the user.

<ZoomImage src="/docs/images/aws-s3/13.webp" alt="Screenshot of Aws" />
1. Select Attach policies directly option
2. Select the policy we created on the previous step
3. Click on **Next** button

<ZoomImage src="/docs/images/aws-s3/14.webp" alt="Screenshot of Aws" />
  - Click on **Create user** button (you don't have to change anything on this page)

Once the Policy is created you will be redirected to this page:
<ZoomImage src="/docs/images/aws-s3/15.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/16.webp" alt="Screenshot of Aws" />
  - Click on **Create access key** option to setup a new access key.

<ZoomImage src="/docs/images/aws-s3/17.webp" alt="Screenshot of Aws" />
  - Choose the **Other** option and click on **Continue** button

<ZoomImage src="/docs/images/aws-s3/18.webp" alt="Screenshot of Aws" />
  - Click on **Create access key** button.

<ZoomImage src="/docs/images/aws-s3/19.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/20.webp" alt="Screenshot of Aws" />

1. Go to the **Storage** section in the sidebar.
2. Click **Add** button

<ZoomImage src="/docs/images/aws-s3/21.webp" alt="Screenshot of Aws" />
...
<ZoomImage src="/docs/images/aws-s3/22.webp" alt="Screenshot of Aws" />

Then go to **settings** page and click on **Backup**
<ZoomImage src="/docs/images/aws-s3/23.webp" alt="Screenshot of Aws" />
<br />
<ZoomImage src="/docs/images/aws-s3/24.webp" alt="Screenshot of Aws" />
