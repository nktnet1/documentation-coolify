...
<Callout type="info" title="Troubleshooting Failed Health Checks">
...
<ZoomImage src="/docs/images/knowledge-base/resources/healthcheck.webp" alt="Healthcheck configuration" />
...
<Callout type="info" title="When to use health checks?">
