...
<ZoomImage src="/docs/images/loadbalancer/one-domain.webp" alt="load-balance-one-domain" />
...
<ZoomImage src="/docs/images/loadbalancer/multiple-domains.webp" alt="load-balance-multiple-domains" />
