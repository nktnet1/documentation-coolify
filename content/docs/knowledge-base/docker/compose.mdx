...
<ZoomImage src="/docs/images/knowledge-base/compose/1.webp" />
...
<ZoomImage src="/docs/images/knowledge-base/compose/2.webp" />
...
| `REALBASE64` or `REALBASE64_32` | Base64-encoded random string, 32 characters. |
| `REALBASE64_64` | Base64-encoded random string, 64 characters. |
| `REALBASE64_128` | Base64-encoded random string, 128 characters. |
...
<Callout type="info" title="Identifier Naming">
