...
<Tabs items={['Debian / Ubuntu / PopOS', 'CentOS / RHEL / Rocky / Fedora', 'SLES/openSUSE', 'Arch Linux', 'Alpine Linux']}>

<Tab value="Debian / Ubuntu / PopOS">
...
<Tab value="CentOS / RHEL / Rocky / Fedora">
...
<Tabs items={['Debian / Ubuntu / PopOS', 'CentOS / RHEL / Rocky / Fedora / Arch / openSUSE', 'Alpine Linux']}>
...
<Tab value="CentOS / RHEL / Rocky / Fedora / Arch / openSUSE">
...
<Tabs items={['Debian / Ubuntu / PopOS', 'CentOS / RHEL / Rocky / Arch / Fedora /openSUSE', 'Alpine Linux']}>
