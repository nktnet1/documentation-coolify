...
<ZoomImage src="/docs/images/builds/servers/banner.webp" alt="Coolify banner" />
...
1. **Add a New Server to Coolify:**
   ...
   <ZoomImage src="/docs/images/builds/servers/1.webp" alt="Coolify dashboard screenshot" />
...
2. **Enable the Build Server Feature:**
   ...
   <ZoomImage src="/docs/images/builds/servers/2.webp" alt="Coolify dashboard screenshot" />

   - If you have already connected your server, enable the Build Server feature as shown in the image below.
   <ZoomImage src="/docs/images/builds/servers/3.webp" alt="Coolify dashboard screenshot" />
...
2. **Activate the Build Server Option:**
   ...
   <ZoomImage src="/docs/images/builds/servers/4.webp" alt="Coolify dashboard screenshot" />
