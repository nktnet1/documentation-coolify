...
If your deployed application or service shows a **"No Available Server"** error, this indicates that [Traefik](/knowledge-base/proxy/traefik) (the reverse proxy) cannot find any (healthy) containers to route traffic to under the provided secured URL (`https`).
...
- [Traefik](/knowledge-base/proxy/traefik) can't reach the application
...
1. **Check exposed Port:**
   ...
   <ZoomImage src="/docs/images/troubleshoot/applications/bad-gateway/1.webp" alt="Screenshot showing No Available Server" />

   In [Applications](/applications), this is defined in the `Ports Exposes` field.

      <ZoomImage src="/docs/images/troubleshoot/applications/bad-gateway/4.webp" alt="Screenshot showing No Available Server" />
...
2. **Verify Application Listening Address:**
   ...
   <ZoomImage src="/docs/images/troubleshoot/applications/bad-gateway/3.webp" alt="Screenshot showing No Available Server" />
...
<ZoomImage src="/docs/images/troubleshoot/applications/bad-gateway/no-available-server/update-traefik-version.webp" alt="coolify proxy traefik version update" />
...
<Callout type="warn" title="Why Coolify don't auto-update for existing servers">
