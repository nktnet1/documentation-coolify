...
<Callout type="warn" title="Docker via Snap Not Supported">
...
<Callout type="error" title="Critical Port">
...
<Callout type="info" title="Registry Authentication">
...
<Callout type="warn" title="Low Disk Space">
