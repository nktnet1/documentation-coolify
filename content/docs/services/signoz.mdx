...
<ZoomImage src="/docs/images/services/signoz-logo.svg" alt="SigNoz logo" />
...
More environment variables are [available to use](https://signoz.io/docs/manage/administrator-guide/configuration/alertmanager/) to authenticate via Identity / Secret or use TLS instead of SmartTLS. Read [Defining environment variables](/knowledge-base/docker/compose#defining-environment-variables) to learn how to add them.
