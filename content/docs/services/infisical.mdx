...
<ZoomImage src="/docs/images/services/infisical-logo.svg" alt="Infisical dashboard" />
...
<ZoomImage src="/docs/images/services/infisical.webp" alt="Infisical dashboard" />
