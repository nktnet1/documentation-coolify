...
<ZoomImage src="/docs/images/services/appflowy.svg" alt="AppFlowy logo" />
...
<ZoomImage src="/docs/images/services/appflowy-screenshots.webp" alt="AppFlowy interface screenshot" />
