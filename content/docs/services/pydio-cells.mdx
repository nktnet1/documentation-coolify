...
<ZoomImage src="/docs/images/services/pydio.webp" alt="Pydio" />
...
<ZoomImage src="/docs/images/services/pydio-screenshot-1.webp" alt="Pydio Cells Onboarding" />

The database details can be found on Coolify dashboard:

<ZoomImage src="/docs/images/services/pydio-screenshot-2.webp" alt="Pydio Cells Onboarding" />
...
- [The official website](https://www.pydio.com/en/pydio-cells/overview?utm_source=coolify.io)
